...
class PluginDisplayTime_v1{
  public function widget_include(){
    ...
    $element = array();
    $element[] = wfDocument::createHtmlElement('style', ".plugin_display_time_v1{}");
  ...
  public function widget_show($data){
    ...
    $element = array();
    $element[] = wfDocument::createHtmlElement('span', null, array('id' => 'plugin_display_time_v1', 'class' => 'plugin_display_time_v1 '.$data->get('data/class')));
